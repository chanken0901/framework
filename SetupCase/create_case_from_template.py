...
def parse_simple_value_from_yaml(text: str, dotted_key: str) -> str:
    ...
    dotted_key = "physics.nse.mach_number" のような多階層キーに対応。
    """
...
def append_case_index(case_index: Path, case_yaml_text: str) -> None:
    ...
    row = {
        ...
        "mach_number": parse_simple_value_from_yaml(
            case_yaml_text,
            "physics.nse.mach_number"
        ),
        
        "reynolds_number": parse_simple_value_from_yaml(
            case_yaml_text,
            "physics.nse.reynolds_number"
        ),
        
        "prandtl_number": parse_simple_value_from_yaml(
            case_yaml_text,
            "physics.nse.prandtl_number"
        ),       
